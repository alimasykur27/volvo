        ...
        <div className='flex-1 flex flex-row bg-gray-50'>
          ...
          <div className='px-8 flex-1 flex flex-col bg-gray-200'>
            <div className='my-24 flex-1 h-64 m-2'>
              <h1 className='mb-4 text-gray-700 text-3xl font-semibold'>ADT A40G Inspection</h1>
              ...
              <div className='w-full flex'>
                <button className='w-[50%] px-6 py-2 mx-auto border-2 border-gray-800 rounded-full text-gray-800 font-medium tracking-widest hover:bg-white active:bg-gray-500'>DOWNLOAD</button>
              </div>
            </div>
          </div>
        </div>
